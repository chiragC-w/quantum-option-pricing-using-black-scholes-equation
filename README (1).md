...
> See [`paper_original.pdf`](./paper_original.pdf) for the original submission (as authored).
...
| `paper_original.pdf` | The original submitted paper, **"Option Pricing with Qiskit Simulations."** |
